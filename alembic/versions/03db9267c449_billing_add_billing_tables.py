...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_billing_accounts_default_payment_method_id"),
        "billing_accounts",
        ["default_payment_method_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_billing_accounts_id"), "billing_accounts", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_billing_accounts_organization_id"),
        "billing_accounts",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_billing_accounts_stripe_customer_id"),
        "billing_accounts",
        ["stripe_customer_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_billing_accounts_stripe_subscription_id"),
        "billing_accounts",
        ["stripe_subscription_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "card_brand", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_billing_payment_methods_billing_account_id"),
        "billing_payment_methods",
        ["billing_account_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_billing_payment_methods_id"),
        "billing_payment_methods",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_billing_payment_methods_stripe_payment_method_id"),
        "billing_payment_methods",
        ["stripe_payment_method_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "hosted_invoice_url", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_billing_invoices_id"), "billing_invoices", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_billing_invoices_stripe_payment_intent_id"),
        "billing_invoices",
        ["stripe_payment_intent_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_billing_invoices_billing_account_id"), table_name="billing_invoices"
    )
    ...
    op.drop_index(
        op.f("ix_billing_payment_methods_id"), table_name="billing_payment_methods"
    )
    op.drop_index(
        op.f("ix_billing_payment_methods_billing_account_id"),
        table_name="billing_payment_methods",
    ...
    op.drop_index(
        op.f("ix_billing_accounts_stripe_customer_id"), table_name="billing_accounts"
    )
    op.drop_index(
        op.f("ix_billing_accounts_organization_id"), table_name="billing_accounts"
    )
