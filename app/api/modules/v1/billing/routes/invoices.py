...
async def download_invoice_pdf(
    ...
    logger.info("GET /billing/invoices/{invoice_id} - Download invoice PDF", extra={
    ...
    try:
        ...
        logger.info("Invoice PDF URL retrieved", extra={
            "invoice_id": str(invoice_id),
            "pdf_url": pdf_url
        })
        ...
        logger.error("Failed to download invoice PDF", exc_info=True, extra={
            "invoice_id": str(invoice_id),
            "error": str(e)
        })
        raise HTTPException(
