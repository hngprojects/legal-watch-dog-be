...
from app.api.modules.v1.jurisdictions.schemas.jurisdiction_schema import JurisdictionCreateSchema, JurisdictionResponseSchema, JurisdictionUpdateSchema
...
async def create_jurisdiction(
    payload: JurisdictionCreateSchema,
...
@router.get("/{jurisdiction_id}", status_code=status.HTTP_200_OK, response_model=JurisdictionResponseSchema)
...
@router.patch("/{jurisdiction_id}", status_code=status.HTTP_200_OK, response_model=JurisdictionResponseSchema)
...
@router.post("/{jurisdiction_id}/restore", status_code=status.HTTP_200_OK, response_model=JurisdictionResponseSchema)
