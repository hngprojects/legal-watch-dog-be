...
class TeamInvitation(SQLModel, table=True):
    ...
    organization: Optional["Organization"] = Relationship(
        sa_relationship=relationship("Organization", backref=backref("invitations", lazy="select"))
    )
    sender: Optional["User"] = Relationship(
        sa_relationship=relationship("User", backref=backref("sent_invitations", lazy="select"))
    )
