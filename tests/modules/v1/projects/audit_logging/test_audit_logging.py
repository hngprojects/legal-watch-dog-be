...
class TestAuditLogging:
    ...
    def test_filter_by_action(self, audit_service):
        ...
        audit_service.log_project_updated(
            project_id=1, org_id=1, user_id=10, changes={"title": {"old": "A", "new": "B"}}
        )
    ...
    def test_organization_audit_logs(self, audit_service):
        ...
        audit_service.log_project_created(project_id=1, org_id=1, user_id=10, details={})
        audit_service.log_project_created(project_id=2, org_id=1, user_id=10, details={})
...
class TestAuditEndpoints:
    ...
    def test_get_project_audit_logs_endpoint(self, client, auth_headers):
        ...
        response = client.get(
            "/api/v1/projects/audit/projects/1",
    ...
    def test_export_audit_logs_csv(self, client, admin_headers):
        """Test CSV export"""
        response = client.get(
            "/api/v1/projects/audit/export?format=csv",
    ...
    def test_audit_statistics(self, client, admin_headers):
        ...
        response = client.get(
            "/api/v1/projects/audit/statistics",
            headers=admin_headers
        )
